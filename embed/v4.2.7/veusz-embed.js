...
function ni(e, t, n, r, l) {
  ...
  vs(function() {
    ...
    if (!(t & 7)) {
      ...
      R && (Ls && n.locale !== "ko" && (Qt || R !== "onCompositionStart" ? R === "onCompositionEnd" && Qt && (C = Rs()) : (st = c, jo = "value" in st ? st.value : st.textContent, Qt = !0)), _ = ll(s, R), 0 < _.length && (R = new Du(R, e, null, n, c), d.push({ event: R, listeners: _ }), C ? R.data = C : (C = Ms(n), C !== null && (R.data = C)))), (C = Ad ? Bd(e, n) : Vd(e, n)) && (s = ll(s, "onBeforeInput"), 0 < s.length && (c = new Du("onBeforeInput", "beforeinput", null, n, c), d.push({ event: c, listeners: s }), c.data = C));
    }
    Ys(d, t);
  });
}
...
function bs(e) {
  ...
  function y(h, f, m, x) {
    ...
    for (C = r(h, C); R < m.length; R++) j = v(C, h, R, m[R], x), j !== null && (e && j.alternate !== null && C.delete(j.key === null ? R : j.key), f = i(j, f, R), _ === null ? S = j : _.sibling = j, _ = j);
  ...
  function k(h, f, m, x) {
    ...
    for (C = r(h, C); !D.done; R++, D = m.next()) D = v(C, h, R, D.value, x), D !== null && (e && D.alternate !== null && C.delete(D.key === null ? R : D.key), f = i(D, f, R), _ === null ? S = D : _.sibling = D, _ = D);
...
function hf({
  ...
  const r = e((w) => w.render), l = e((w) => w.tree), i = e((w) => w.currentPage), o = e((w) => w.values), u = e((w) => w.requestRender), a = M.useRef(null), s = M.useRef(null), c = M.useRef(null), d = M.useMemo(() => {
    ...
    return { w, h: L };
  }, [t, n]), [p, v] = M.useState({ w: t, h: n }), [y, k] = M.useState(null), [N, h] = M.useState(null), [f, m] = M.useState(null), x = M.useRef(/* @__PURE__ */ new Set()), S = M.useRef(null), _ = M.useRef(null), C = M.useRef(/* @__PURE__ */ new Map()), R = M.useRef(0);
  M.useEffect(() => {
    const w = s.current;
    if (!w) return;
...
function mm({
  ...
  const o = e((S) => S.tree), u = e((S) => S.selected), a = e((S) => S.schema), s = e((S) => S.values), c = e((S) => S.datasets), d = e((S) => S.error), p = e((S) => S.canUndo), v = e((S) => S.canRedo), [y, k] = M.useState(!1), [N, h] = M.useState(!1);
  M.useEffect(() => {
